...
#Deterministic binned-spectrum MKM from TOPAS ySpecfile.txt
../bin/monas -MKMFromSpectra -outputDir MKM_from_spectra_output -spectrum TOPAS:topas:ySpecfile.txt -MKMSatCorr -MKMnonPoiss -SMKM -MKM_rDomain 0.44 -MKM_rNucleus 8.0 -MKM_alpha 0.19 -MKM_beta 0.07 -MKM_y0 150 -MKM_alphaX 0.19 -MKM_betaX 0.05 -Doses 0 10 1
