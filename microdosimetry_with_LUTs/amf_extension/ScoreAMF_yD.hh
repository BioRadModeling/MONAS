#ifndef SCOREAMF_YD_HH
#define SCOREAMF_YD_HH
...
public:
    ...
    LookupEntry(double e, const std::vector<double>& sp)
        : energy(e), stoppingPowers(sp) {}
};

class ScoreAMF_yD : public TsVBinnedScorer {
public:
    ScoreAMF_yD(TsParameterManager* pM,
